...
function getQuiz(selectedQuizID) {
    ...
    fetch(`http://www.cozyquiz.com/api/quiz_selection_api_endpoint/${selectedQuizID}/`, {
        method: 'GET',
        headers: {
...
function showFinalElements() {
    ...
    fetch(`http://www.cozyquiz.com/api/receive_user_score_api_endpoint/${userCorrectScore}/`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            'X-CSRFToken': csrftoken,
